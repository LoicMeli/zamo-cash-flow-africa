...
export const translations = {
  en: {
    ...
    agents: {
      ...
      open: "Open",
      closed: "Closed",
      distanceLabel: "Distance", // Fixed duplicate 'distance' key
      ...
      distanceFilter: "Distance", // Changed to distanceFilter to avoid duplicate
  ...
  fr: {
    ...
    settings: {
      ...
      security: {
        title: "Sécurité",
        usePIN: "Utiliser un PIN pour les transactions",
        usePINDescription: "Exiger un PIN pour les opérations sensibles",
        useBiometrics: "Utiliser la biométrie",
        useBiometricsDescription: "Utiliser l'empreinte digitale ou la reconnaissance faciale pour l'authentification",
    ...
    notifications: {
      ...
      billReminder: "Rappel: {{billName}} à payer dans {{daysLeft}} jours",
    ...
    scan: {
      ...
      instructions: "Pointez votre appareil photo sur un code QR",
      invalidCode: "Code QR invalide",
      unsupportedFormat: "Format QR non pris en charge",
      permissionDenied: "Permission d'accès à l'appareil photo refusée",
      enableCamera: "Veuillez activer l'accès à l'appareil photo dans vos paramètres",
      tryAgain: "Réessayer",
      loading: "Initialisation de l'appareil photo..."
    },
    contacts: {
      title: "Contacts",
    ...
    referral: {
      ...
      step1Text: "Envoyez votre code de parrainage à vos amis",
      step2Title: "Vos amis s'inscrivent",
      step2Text: "Ils créent un compte avec votre code",
      step3Title: "Vous gagnez tous les deux",
      step3Text: "Vous recevez chacun 500 FCFA après leur première transaction",
  ...
  pidgin: {
    // Basic translations for Pidgin language
    common: {
      send: "Send",
      receive: "Collect",
      scan: "Scan",
  ...
  camfran: {
    // Basic translations for Camfranglais language
    common: {
      send: "Envoyé",
      receive: "Recevoir",
      scan: "Scanner",
