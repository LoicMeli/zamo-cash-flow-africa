  ...
  fr: {
    ...
    settings: {
      ...
      security: {
        ...
        usePINDescription: "Demander PIN pour opérations sensibles",
        useBiometrics: "Utiliser Biométrie",
        useBiometricsDescription: "Utiliser empreinte digitale ou Face ID",
    ...
    notifications: {
      ...
      billReminder: "Rappel: {{billName}} due dans {{daysLeft}} jours",
    ...
    scan: {
      ...
      instructions: "Pointez votre caméra vers un QR code",
    ...
    referral: {
      ...
      description: "Pour chaque ami qui s'inscrit et fait une transaction, vous recevez tous les deux 500 FCFA",
      ...
      pending: "En attente",
      completed: "Complété",
      noReferrals: "Vous n'avez pas encore parrainé quelqu'un",
      shareMessage: "Rejoignez-moi sur Zamo! Utilisez mon code {{code}} pour vous inscrire et nous recevrons chacun 500 FCFA. Téléchargez l'application: [lien]",
