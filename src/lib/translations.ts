export const translations = {
  ...
  fr: {
    ...
    notifications: {
      ...
      yesterday: "Hier",
      earlier: "Plus tôt",
      transactionSent: "Vous avez envoyé {{amount}} à {{recipient}}",
      transactionReceived: "Vous avez reçu {{amount}} de {{sender}}",
      goalReached: "Vous avez atteint votre objectif d'épargne pour {{goalName}}",
      securityAlert: "Nouvelle connexion détectée depuis {{location}}",
      newPromotion: "Nouvelle promotion: {{promotionTitle}}",
      billReminder: "Rappel: {{billName}} dû dans {{daysLeft}} jours",
      familyExpense: "Nouvelle dépense familiale ajoutée: {{expenseName}}",
      groupContribution: "Nouvelle contribution dans {{groupName}}"
    },
    profile: {
      title: "Profil",
      ...
      linkMomoAccount: "Lier un compte Mobile Money",
    ...
    scan: {
      ...
      unsupportedFormat: "Format QR non supporté",
      permissionDenied: "Permission de caméra refusée",
      enableCamera: "Veuillez activer l'accès à la caméra dans vos paramètres",
      tryAgain: "Réessayer",
    ...
    contacts: {
      ...
      alreadyExists: "Ce contact existe déjà",
    },
    referral: {
      title: "Parrainer et gagner",
      subtitle: "Invitez des amis pour gagner des récompenses",
      description: "Pour chaque ami qui s'inscrit et effectue une transaction, vous deux recevez tous les deux 500 FCFA",
