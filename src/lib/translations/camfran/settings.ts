...
export const settings = {
  ...
  accountSettings: {
    ...
    deleteWarning: "Cette action est définitive. Toutes tes données vont disparaître."
  },
  ...
  securitySettings: {
    ...
    enableSms: "Activer la vérification par SMS",
  ...
  biometrics: "Activer l'authentification biométrique",
