...
type MobileMoneyWithdrawNavigationProp = NativeStackNavigationProp<RootStackParamList, 'RemoveMoney'>;
...
export const MobileMoneyWithdraw = () => {
  const navigation = useNavigation<MobileMoneyWithdrawNavigationProp>();
  ...
  // Calculate fee (example: 0.5% of amount)
  const calculateFee = () => {
  ...
  const submitWithdrawal = () => {
    ...
    setTimeout(() => {
      ...
      Alert.alert(
        ...
        "Your withdrawal has been initiated. You will receive your money within 5-15 minutes.",
        [
          { 
            text: "OK", 
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.header}>
          <TouchableOpacity style={styles.backButton} onPress={goBack} disabled={processing}>
            <Ionicons name="arrow-back" size={24} color="#FFF" />
          </TouchableOpacity>
          <Text style={styles.headerTitle}>Mobile Money Withdrawal</Text>
          <View style={{ width: 40 }} />
        </View>
        ...
        >
          ...
          {step === 1 ? (
            ...
            >
              <Text style={styles.stepTitle}>Withdraw to Mobile Money</Text>
              
              <View style={styles.balanceCard}>
                <Text style={styles.balanceLabel}>Available Balance</Text>
                <Text style={styles.balanceValue}>{userBalance.toLocaleString()} FCFA</Text>
              </View>
            ...
            >
              ...
              <View style={styles.formGroup}>
                <Text style={styles.label}>Enter your PIN to confirm</Text>
                <TextInput
              ...
              <TouchableOpacity 
                style={[
                  styles.button,
                  { backgroundColor: getOperatorColor(selectedOperator), opacity: processing ? 0.7 : 1 }
                ]}
              ...
              <View style={styles.noteSection}>
                ...
                <Text style={styles.noteText}>
                  By confirming, you authorize Zamo to process this withdrawal to your mobile money account.
                </Text>
              </View>
            </Animated.View>
          )}
